...
public class C02_bonigarciaWebDriver {
    public static void main(String[] args) {
        ...
        WebDriverManager.chromedriver().setup(); // Calistigimiz sirket isterse,  class in basinda web driver olarak bizim istedigimiz ve
                                                // yukledigimiz webdriver in ayarlarini gecerli yaptik.Istemezse Selenium webdriver kafi.
